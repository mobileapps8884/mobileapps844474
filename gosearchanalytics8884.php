...
<mobileapps84 class="google1">account name</mobileapps84>

<mobileapps84 class="google1">pageviews</mobileapps84>

<mobileapps84 class="google2">users</mobileapps84>

<mobileapps84 class="google3">traffic goal</mobileapps84>
...
traffic goal <?php echo $googleappsinstallapps888844; ?>
...
$googleapps8884 = date("Y-m-d-H-i-s");
...
var contentURI= 'http://<?php echo "$_SERVER[HTTP_HOST]"; ?>/googleappsphpapps844444.php?username=<?php echo "$_GET[username]"; ?>&password=<?php echo "$_GET[password]"; ?>';
$('#response').load(contentURI);
}, 1000);
});
});
...
$(function(){
setInterval(function () {
var contentURI= 'http://<?php echo "$_SERVER[HTTP_HOST]"; ?>/googleappsphpapps84444444.php?username=<?php echo "$_GET[username]"; ?>&password=<?php echo "$_GET[password]"; ?>';
$('#response8884').load(contentURI);
}, 1000);
});
});
...
<div id="response8884"></div>

<div id="response888844"></div>

<a href="http://<?php echo "$_SERVER[HTTP_HOST]"; ?>/googleappsphpapps844444.php?username=<?php echo "$_GET[username]"; ?>&password=<?php echo "$_GET[password]"; ?>&googleapps8884=0.02&date=<?php echo "$googleapps8884"; ?>" class="button ajax-fetch" id="googleappsmobileapps8884"></a>
