...
<div style="padding-bottom:8px;padding-top:8px;padding-left:8px;">website url for your ad</div>
<input name="field2" type="text" class="input1" id="input54" autocomplete="off"/>
<div style="padding-bottom:8px;padding-top:8px;padding-left:8px;">description for your ad</div>
<input name="field84" type="text" class="input1" id="input84" autocomplete="off" style="margin-bottom:0px;"/>
<input name="url" type="hidden" value='<?php echo "$googleappsmobileappsinstallapps88888844"; ?>' />
...
<div class="googleappsuserappsregisterappsgoogleapps84" style="padding-bottom:18px;">
if payment is complete the input and the create ad button should enable
</div>
...
<input type="submit" value="Publish" name="sub" id="googleappsinstallapps84" style="margin-top:-18px;"/>
