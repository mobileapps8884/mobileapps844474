...
<div class="googlemobileapps8884" style="margin-top:18px;" onclick="window.open('<?php echo "http://mobile84.herokuapp.com/ads/publishprepaid.php?payment=100"; ?>','_self');ga('send', 'event', 'googleapps8884', 'Click','ExternalLink84');">

prepaid

</div>

<div class="googlemobileapps8884" style="margin-top:18px;" onclick="window.open('<?php echo "http://$_SERVER[HTTP_HOST]/ads/login.php"; ?>','_self');ga('send', 'event', 'googleapps8884', 'Click','ExternalLink84');">
